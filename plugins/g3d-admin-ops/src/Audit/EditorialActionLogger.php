...
interface EditorialActionLogger
{
     ...
     *
     * @param array<string,mixed> $context Debe incluir la clave 'what'; opcionalmente 'occurred_at', 'snapshot_id', 'resultado',
     *                                     'latency_ms' según Capa 3 — Validación, Firma Y Caducidad — Actualizada (slots Abiertos)
     *                                     — V2 (urls).md §Auditoría.
     */
